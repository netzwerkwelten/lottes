...
import { TweenMax, TimelineMax, Cubic, Quart } from 'gsap';
import * as createjs from 'createjs-module';

@Component({
  selector: 'app-intro-3d',
  templateUrl: './intro-3d.component.html',
  styleUrls: ['./intro-3d.component.scss']
})
export class Intro3dComponent implements OnInit {
  private __extends: (d, b) => void;
  ...
  ngOnInit() {
    ...
    (function(demo) {
       ...
       * @author Yausnobu Ikeda a.k.a clockmaker
       */
      const DemoIconsWorld = (function(_super) {
        ...
        DemoIconsWorld.prototype.setup = function() {
          ...
          const SIZE = 256;
          for (let i = 0, len = this._matrixLength * this._matrixLength; i < len; i++) {
        ...
        DemoIconsWorld.prototype.createParticleCloud = function() {
          ...
          // マテリアルを作成
          const texture = THREE.ImageUtils.loadTexture('http://ics-web.jp/lab-data/150601_threejs_mosaic/imgs/fire_particle.png');
        ...
        DemoIconsWorld.prototype.createLogo = function() {
          ...
          const text1 = new createjs.Text(this.WORD_LIST[this._wordIndex], "30px " + FONT_NAME, "#FFF");
          this._wordIndex++;
